...
// Action
export type Action =
  | { type: 'SETTINGS_TOGGLE', settingsOpen: boolean}
  ...
  | { type: 'EMPLOYER_REQUESTING', employerUri: string, employerWebsite: string }
  | { type: 'EMPLOYER_SUCCESS', employerUri: string, employerWebsite: string, data: Object }
  | { type: 'EMPLOYER_FAILURE', employerUri: string, employerWebsite: string, err: any };
